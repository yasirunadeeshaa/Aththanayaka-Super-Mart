...
const T = {
  blurb: {
    ...
    si: "ශ්‍රී ලංකාවේ විශ්වාසනීය තල ඇට, හකුරු සහ නිෂ්පාදන ද්‍රව්‍ය සැපයුම්කරු — දශකයකට වැඩි කාලයක් ගුණාත්මකභාවය හා සැලකිල්ලෙන්.",
  },
  shopHeading:    { en: "Shop",            si: "වෙළඳසැල" },
  companyHeading: { en: "Business",         si: "සමාගම" },
  contactHeading: { en: "Get In Touch",    si: "අප හා සම්බන්ධ වන්න" },
  newsHeading:    { en: "Stay Stocked Up", si: "තොගයෙන් යුක්ත වෙන්න" },
  newsSub: {
    en: "New stock alerts & seasonal offers no spam, just sesame.",
    si: "නව තොග දැනුම්දීම් සහ සමයානුකූල දීමනා — spam නැත, තල ඇට පමණි.",
  },
  ...
  jaggery:          { en: "Organic Jaggery",          si: "කාබනික හකුරු" },
  about:            { en: "About Us",                 si: "අප ගැන" },
  offers:           { en: "Offers",                   si: "දීමනා" },
  wholesale:        { en: "Wholesale Orders",          si: "තොග ඇණවුම්" },
  contact:          { en: "Contact",                  si: "සම්බන්ධතාවය" },
  address: {
    en: "No. 124, Main Street, Sri Lanka",
    si: "අංක 124, ප්‍රධාන වීදිය, ශ්‍රී ලංකාව",
  },
  hours: { en: "Tue – Sun, 8.00 AM – 7.00 PM", si: "සඳුදා – සෙනසුරාදා, පෙ.ව. 8.00 – ප.ව. 7.00" },
  rights: { en: "All rights reserved.", si: "සියලු හිමිකම් ඇවිරිණි." },
  madeWith: { en: "Sesame, sourced honestly.", si: "තල ඇට, අවංකව සපයන ලද." },
